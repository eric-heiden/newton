...
- Add `SolverSPH`, an experimental Warp-accelerated particle-fluid solver, and add ViewerGL screen-space fluid rendering with translucent smoothed water surfaces, tunable blur radius, tropical optical-depth color absorption, stronger env-map reflection/refraction and env transmission, ripple/caustic distortion, and screen-space foam for particle fluids.
