...
- Add `SolverSPH`, an experimental Warp-accelerated particle-fluid solver, and add ViewerGL screen-space fluid rendering with translucent smoothed water surfaces, tunable blur radius, tropical color gradients, refraction/reflection, Fresnel-weighted environment-map reflection, procedural caustic highlights, and screen-space foam for particle fluids.
