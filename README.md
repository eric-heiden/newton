...
<table>
  ...
  <tr>
    <td align="center" width="33%">
      <a href="https://github.com/newton-physics/newton/blob/main/newton/examples/sensors/example_sensor_model_cameras.py">
        <img width="320" src="https://raw.githubusercontent.com/newton-physics/newton/main/docs/images/examples/example_sensor_model_cameras.jpg" alt="Sensor Model Cameras">
      </a>
    </td>
    <td align="center" width="33%">
    </td>
  ...
  <tr>
    <td align="center" width="33%">
      <code>python -m newton.examples sensor_model_cameras</code>
    </td>
    <td align="center" width="33%">
    </td>
    <td align="center" width="33%">
