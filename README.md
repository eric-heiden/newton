...
<table>
  ...
  <tr>
    ...
    <td align="center" width="33%">
      <a href="https://github.com/newton-physics/newton/blob/main/newton/examples/cable/example_cable_flying_knot.py">
        <img width="320" src="https://raw.githubusercontent.com/newton-physics/newton/main/docs/images/examples/example_cable_flying_knot.jpg" alt="Cable Flying Knot">
      </a>
    </td>
  </tr>
  <tr>
    ...
    <td align="center" width="33%">
      <code>python -m newton.examples cable_flying_knot</code>
    </td>
  </tr>
  <tr>
    <td align="center" width="33%">
      <a href="https://github.com/newton-physics/newton/blob/main/newton/examples/cable/example_cable_flying_knot_mujoco.py">
        <img width="320" src="https://raw.githubusercontent.com/newton-physics/newton/main/docs/images/examples/example_cable_flying_knot_mujoco.jpg" alt="Cable Flying Knot (MuJoCo-coupled)">
      </a>
    </td>
    <td align="center" width="33%">
    </td>
  ...
  <tr>
    <td align="center" width="33%">
      <code>python -m newton.examples cable_flying_knot_mujoco</code>
    </td>
    <td align="center" width="33%">
    </td>
    <td align="center" width="33%">
