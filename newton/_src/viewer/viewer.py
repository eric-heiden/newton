...
class ViewerBase(ABC):
    ...
    def clear_model(self) -> None:
        ...
        self.fluid_thickness_scale = 0.55
        self.fluid_smoothing_iterations = 7
        self.fluid_smoothing_radius = 3.83
        self.fluid_smoothing_depth_edge_falloff = 5.5
        ...
        self.fluid_env_reflection_lod = 1.8
        self.fluid_env_color_preserve = 0.57
        self.fluid_absorption_strength = 1.2
        ...
        self.fluid_surface_shadow_strength = 0.35
