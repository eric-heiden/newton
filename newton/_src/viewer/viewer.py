...
class ViewerBase(ABC):
    ...
    def _init_layer_state(self, layer: Layer) -> None:
        ...
        layer.fluid_color = (0.10, 0.50, 0.80)
        layer.fluid_deep_color = (0.01, 0.09, 0.34)
        layer.fluid_color_gradient_strength = 0.20
        layer.fluid_opacity = 1.00
        layer.fluid_radius_scale = 1.34
        layer.fluid_thickness_scale = 0.55
        layer.fluid_smoothing_iterations = 7
        layer.fluid_smoothing_radius = 3.83
        layer.fluid_smoothing_depth_edge_falloff = 5.5
        layer.fluid_smoothing_max_samples = 4
        layer.fluid_reflection_strength = 0.528
        layer.fluid_refraction_strength = 0.038
        layer.fluid_env_map_strength = 1.02
        layer.fluid_env_reflection_lod = 1.8
        layer.fluid_env_color_preserve = 0.57
        layer.fluid_absorption_strength = 1.2
        layer.fluid_depth_visualization_strength = 2.13
        layer.fluid_caustic_strength = 3.03
        layer.fluid_caustic_scale = 37.1
        layer.fluid_floor_caustic_strength = 1.15
        layer.fluid_surface_shadow_strength = 0.35
        layer.fluid_foam_strength = 0.99
        layer.fluid_foam_scale = 5.0
        layer.show_fluid_diffuse = True
        layer.fluid_diffuse_color = (1.0, 1.0, 1.0)
        layer.fluid_diffuse_alpha = 0.34
        layer.fluid_diffuse_radius = 0.016
        layer.fluid_diffuse_motion_blur_scale = 0.12
        layer.fluid_diffuse_expansion = 0.55
        layer.fluid_diffuse_inscatter = 0.80
        layer.fluid_diffuse_outscatter = 0.30
        layer.fluid_diffuse_shadow_strength = 0.35
    ...
    def log_fluid(
        ...
        surface_shadow_strength: float = 0.35,
        ...
        if self.model.particle_count:
            ...
            if self.model.particle_flags is not None:
                ...
                if active_count == 0:
                    ...
                    self.log_fluid(name=self._qualify("/model/fluid"), points=None, hidden=True)
            ...
            if self.show_fluid:
                ...
                self.log_fluid(
                    ...
                    hidden=self._layer_force_hidden(),
                )
            else:
