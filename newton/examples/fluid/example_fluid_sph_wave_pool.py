...
class Example:
    def __init__(self, viewer, args):
        ...
        self.viewer.fluid_diffuse_expansion = 0.45
        # Shallow sunny-pool palette: a brighter deep color and softer
        # absorption keep the far edge sky-lit instead of fading to black.
        self.viewer.fluid_deep_color = (0.045, 0.22, 0.46)
        self.viewer.fluid_absorption_strength = 0.95
        self.viewer.fluid_diffuse_inscatter = 0.85
        self.viewer.fluid_diffuse_outscatter = 0.30
        self.viewer.fluid_diffuse_shadow_strength = 0.30
    ...
    def create_parser():
        ...
        parser.add_argument("--dim-x", type=int, default=96)
        parser.add_argument("--dim-y", type=int, default=40)
        ...
        parser.add_argument("--emit-lower", type=float, nargs=3, default=(-2.16, -0.66, 0.05))
        ...
        parser.add_argument("--particle-friction", type=float, default=0.05)
        parser.add_argument("--cohesion", type=float, default=0.030)
        parser.add_argument("--surface-tension", type=float, default=0.0000006)
        parser.add_argument("--xsph-strength", type=float, default=0.10)
        parser.add_argument("--free-surface-drag", type=float, default=0.10)
        parser.add_argument("--dissipation", type=float, default=0.20)
        ...
        parser.add_argument("--paddle-x", type=float, default=-2.16)
        parser.add_argument("--paddle-height", type=float, default=0.42)
        parser.add_argument("--paddle-amplitude", type=float, default=0.17)
        parser.add_argument("--paddle-period", type=float, default=2.0)
        parser.add_argument("--beach-start", type=float, default=0.55)
        parser.add_argument("--beach-length", type=float, default=2.3)
        parser.add_argument("--beach-angle-deg", type=float, default=11.0)

        parser.add_argument("--fluid-diffuse-max-particles", type=int, default=20000)
        parser.add_argument("--fluid-diffuse-threshold", type=float, default=1.6)
        ...
        parser.add_argument("--fluid-diffuse-alpha", type=float, default=0.45)
        parser.add_argument("--fluid-diffuse-motion-blur", type=float, default=0.40)
        ...
        parser.add_argument("--camera-pos", type=float, nargs=3, default=(1.55, -2.05, 0.95))
        parser.add_argument("--camera-pitch", type=float, default=-15.0)
        parser.add_argument("--camera-yaw", type=float, default=140.0)
        return parser
