...
class ModelBuilder:
    ...
    class JointDofConfig:
        ...
        def __init__(
            ...
            """The target position for this joint drive. If the target position is outside the limits, it will be set to the center position of the limits."""
            self.target_vel = target_vel
            """The target velocity for this joint drive."""
    ...
    def add_joint_revolute(
        ...
        Args:
            ...
            target_pos: The target angle (in radians) of the joint.
            target_vel: The target angular velocity of the joint.
