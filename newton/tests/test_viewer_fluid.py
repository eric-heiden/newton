...
class TestViewerFluid(unittest.TestCase):
    ...
    def test_default_fluid_material_matches_water_shader_preset(self):
        ...
        self.assertAlmostEqual(viewer.fluid_diffuse_radius, 0.016)
        self.assertAlmostEqual(viewer.fluid_diffuse_alpha, 0.34)
        self.assertAlmostEqual(viewer.fluid_diffuse_motion_blur_scale, 0.12)
        self.assertAlmostEqual(viewer.fluid_diffuse_expansion, 0.55)
        self.assertAlmostEqual(viewer.fluid_diffuse_inscatter, 0.80)
        self.assertAlmostEqual(viewer.fluid_diffuse_outscatter, 0.30)
        self.assertAlmostEqual(viewer.fluid_diffuse_shadow_strength, 0.35)
    ...
    def test_interactive_tank_parser_exposes_shader_and_picking_controls(self):
        ...
        self.assertEqual(args.dim_x, 80)
        self.assertEqual(args.dim_y, 50)
        self.assertEqual(args.dim_z, 14)
        ...
        self.assertGreaterEqual(args.free_surface_drag, 0.1)
        self.assertGreater(args.dissipation, 0.1)
